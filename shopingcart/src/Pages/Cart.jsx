...
import CarttItems from '../Components/CarttItems';
  ...
  return (
    <>
      <div className="container mx-auto px-4 md:px-8 pt-8">
        ...
        <h2 className='text-4xl font-extrabold text-white mb-10 tracking-tight'>Shoping cart ({cartCount})</h2>

        <div className='grid grid-cols-1 lg:grid-cols-3 gap-10'>
          <div className='lg:col-span-2 space-y-4'>
            {cart.map((item)=>(
              <CarttItems key={item.id} item={item}/>
            ))}
          </div>
          ...
          <div className="lg:col-span-1 p-8 bg-gray-900 rounded-2xl shadow-2xl border-1-4 sticky top-20 h-fit border border-gray-800">
            ...
            <Link to={"/checkout"} className='w-full mt-8 py-4 bg-orange-600 text-white font-extrabold text-xl rounded-full shadow-lg shadow-orange-800/50 cursor-pointer hover:bg-orange-700 transition duration-300 flex items-center justify-center space-x-2 transform hover:ring-4 hover:ring-pink-600/50 uppercase tracking-wider'>
